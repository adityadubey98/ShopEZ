...
const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
      <img src="/assets/bottom_banner_image.png" alt="banner" className="w-full hidden md:block" />
      <img src="/assets/bottom_banner_image_sm.png" alt="banner" className="w-full md:hidden" />
